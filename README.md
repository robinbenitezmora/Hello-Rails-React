...
# 📖 Hello React Ruby <a name="about-project"></a>


**Hello React Ruby** is a practice application in order to know how you can connect React with Rails.
...
> git clone git@github.com:robinbenitezmora/Hello-Rails-React.git
